...
func (r contentUpsertRequest) ToInput() domain.ContentUpsertInput {
	return domain.ContentUpsertInput{
		Title:       r.Title,
...
func (h ContentHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	result, err := h.service.Create(r.Context(), input.ToInput())
	if err != nil {
...
func (h ContentHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	result, err := h.service.Update(r.Context(), r.PathValue("contentID"), input.ToInput())
	if err != nil {
		httpx.WriteDomainError(w, err, "valid content fields are required", "content not found")
		return
	}
